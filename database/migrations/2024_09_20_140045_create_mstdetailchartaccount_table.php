...
return new class extends Migration {
    ...
    {
        Schema::create('mstdetailchartaccount', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('chart_account_id')->references('id')->on('mstchartaccount')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('mstdetailchartaccount');
    }
};

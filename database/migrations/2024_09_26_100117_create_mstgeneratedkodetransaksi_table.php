...
return new class extends Migration {
    ...
    {
        Schema::create('mstgeneratedkodetransaksi', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign(columns: 'form_id')->references('id')->on('mstform')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('mstgeneratedkodetransaksi');
    }
};
